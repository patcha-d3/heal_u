...
export default function RootPage() {
	...
	return (
		<div className='w-[406px] h-[800px] relative'>
			...
			<div className='absolute bottom-[32px] left-0 right-0 flex justify-between px-[11px]'>
				<ButtonBack
					onClick={() =>
						router.push(
							"/onboarding/step-one"
			...
			<main className='h-full flex flex-col px-4 py-[18px] pb-24'>
				<SurveyProgress
					currentStep={currentStep}
					totalSteps={totalSteps}
				/>
				<h2 className='text-2xl font-semibold text-[#29424D] text-center gap-6 mt-8'>
