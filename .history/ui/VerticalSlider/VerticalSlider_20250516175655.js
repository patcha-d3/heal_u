...
const Verticalslider = ({ value, onChange }) => {
	...
	const updateValue = (e) => {
		...
		// Calculate position relative to track height
		const percentage = Math.max(0, Math.min(1, y / TRACK_HEIGHT));
	...
	const thumbPosition = (value / 12) * TRACK_HEIGHT;
